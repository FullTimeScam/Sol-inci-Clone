      ...
      <div>
        <div className="flex flex-col flex-wrap lg:flex-row lg:items-center justify-between">
          <div className="basis-full lg:basis-2/5 flex justify-start items-start h-full flex-grow lg:justify-start">
            <a href="/">
              <img
                className="h-14 md:h-16 lg:h-20 lg:w-[600px]"
                src="/images/incinerator-logo.svg"
          ...
          <div className="basis-full gap-y-1 justify-around flex sm:flex-nowrap items-center md:mb-2.5 mt-1 sm:mt-2.5 md:mt-5 lg:mt-0 lg:basis-2/5 lg:justify-end">
            ...
            >
              <svg
                ...
                viewBox="0 0 640 512"
                color="white"
                className="svg-inline--fa fa-discord text-2xl md:text-3xl"
              >
                <path
                  fill="currentColor"
            ...
            <a href="https://twitter.com/solincinerator"></a>
          </div>
        </div>
